...
{
	private final Map<String, TermVector>	storage	= new HashMap<String, TermVector>();

	/**
	 * @see net.sf.classifier4J.vector.TermVectorStorage#addTermVector(java.lang.String,
	 *      net.sf.classifier4J.vector.TermVector)
	 */
