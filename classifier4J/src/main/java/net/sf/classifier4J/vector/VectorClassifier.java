...
public class VectorClassifier extends AbstractCategorizedTrainableClassifier
{
	...
	private final int				numTermsInVector				= 25;
	private final ITokenizer		tokenizer;
	private final IStopWordProvider	stopWordsProvider;
			...
			throws ClassifierException
	{
		...
		Map<String, Integer> wordFrequencies = Utilities.getWordFrequency(
				input, false, tokenizer, stopWordsProvider);
		...
		{
			int[] inputValues = generateTermValuesVector(tv.getTerms(),
					wordFrequencies);
	...
	/**
	 * @see net.sf.classifier4J.ITrainable#teachMatch(java.lang.String,
	 *      java.lang.String)
	 */
			...
			throws ClassifierException
	{
		...
		Set<String> mostFrequentWords = Utilities.getMostFrequentWords(
				numTermsInVector, wordFrequencies);

		String[] terms = mostFrequentWords.toArray(new String[mostFrequentWords
				.size()]);
		Arrays.sort(terms);
	 ...
	 * @return
	 */
	protected int[] generateTermValuesVector(String[] terms,
	...
	/**
	 * @see net.sf.classifier4J.ITrainable#teachNonMatch(java.lang.String,
	 *      java.lang.String)
	 */
